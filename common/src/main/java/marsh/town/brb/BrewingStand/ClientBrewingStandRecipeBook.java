...
import marsh.town.brb.Mixins.Accessors.BrewingRecipeRegistryAccessor;
    ...
    public List<BrewingResult> getResultsForCategory(BrewingRecipeBookGroup group) {
        ...
        for (PotionBrewing.Mix<Potion> potionRecipe : recipeCollection) {
            if (group == BrewingRecipeBookGroup.BREWING_POTION) {
                brewingResults.add(new BrewingResult(PotionUtils.setPotion(new ItemStack(Items.POTION), (Potion) ((BrewingRecipeRegistryMixAccessor<?>)potionRecipe).getTo()), potionRecipe));
            } else if (group == BrewingRecipeBookGroup.BREWING_SPLASH_POTION) {
                brewingResults.add(new BrewingResult(PotionUtils.setPotion(new ItemStack(Items.SPLASH_POTION), (Potion) ((BrewingRecipeRegistryMixAccessor<?>)potionRecipe).getTo()), potionRecipe));
            } else if (group == BrewingRecipeBookGroup.BREWING_LINGERING_POTION) {
                brewingResults.add(new BrewingResult(PotionUtils.setPotion(new ItemStack(Items.LINGERING_POTION), (Potion) ((BrewingRecipeRegistryMixAccessor<?>)potionRecipe).getTo()), potionRecipe));
            }
        }
